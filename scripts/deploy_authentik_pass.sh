...
AUTH_SECRET_KEY=`$NODE $BW --session $BW_SESSION get password "authentik secret key"`
PG_PASSWD=`$NODE $BW --session $BW_SESSION get password "9157437f-bdb0-49c5-8538-ac0638b8d145"`
echo "AUTH_SECRET_KEY=\"$AUTH_SECRET_KEY\"" > $HOME/fabricant-prod/.secrets/authentik_admin_password.env
