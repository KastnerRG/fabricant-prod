...
echo "LABEL_STUDIO_PASSWORD=\"$LABEL_ADMIN_PASSWD\"" > $HOME/fabricant/.secrets/label_studio_admin_password_pg.env
echo "POSTGRES_USER=\"$PG_PASSWD\"" >> $HOME/fabricant/.secrets/label_studio_admin_password_pg.env
